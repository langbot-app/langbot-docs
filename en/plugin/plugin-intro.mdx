...
Plugins are managed uniformly by the Plugin Runtime. Most plugins use a dedicated runtime; a reviewed release may be shown as a [Certified Plugin](/en/plugin/certified-plugins) and use the Certified Plugin allowance in LangBot Cloud.
